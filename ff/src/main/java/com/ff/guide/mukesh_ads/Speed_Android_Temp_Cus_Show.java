...
public class Speed_Android_Temp_Cus_Show extends FrameLayout {

    private int templateType = R.layout.ad_unit_admob_med;
    private int templateMinHeight = 120;
    private Speed_Android_NAd_Temp styles;
...
//    private LinearLayout background;
    ...
    public Speed_Android_Temp_Cus_Show(Context context) {
        super(context);
    }

    public Speed_Android_Temp_Cus_Show(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public Speed_Android_Temp_Cus_Show(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @SuppressLint("NewApi")
    public Speed_Android_Temp_Cus_Show(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        initView(context, attrs);
    }

    public void setStyles(Speed_Android_NAd_Temp styles) {
        this.styles = styles;
        this.applyStyles();
    }
