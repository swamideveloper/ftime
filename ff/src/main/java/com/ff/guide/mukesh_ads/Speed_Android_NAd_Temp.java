...
public class Speed_Android_NAd_Temp {
  ...
  public static class Builder {
    ...
    private final Speed_Android_NAd_Temp styles;

    public Builder() {
      this.styles = new Speed_Android_NAd_Temp();
    }
    ...
    public Speed_Android_NAd_Temp build() {
      return styles;
    }
  }
}
