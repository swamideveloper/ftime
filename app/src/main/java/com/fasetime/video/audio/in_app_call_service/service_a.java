...
public class service_a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.in_app_i);

        incoming_counter = 0;
        Log.e("@demo", "counter: " + incoming_counter);
    ...
    private void connectVideoCall() {
        ...
        startActivity(new Intent(service_a.this, service_c.class));
        finish();
    }
    ...
    public boolean isStoragePermissionGranted(int request) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (checkSelfPermission(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED && checkSelfPermission(Manifest.permission.INTERNET) == PackageManager.PERMISSION_GRANTED) {
                ...
                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.CAMERA, Manifest.permission.INTERNET}, request);
                return false;
            }
        } else {
            Log.v("TAG", "Permission is granted");
